...
\begin{abstract}
	...
	due bobine in configurazione di Helmholtz.

	Dalla conoscenza di $B$ e $V_{acc}$ e dalla misura del raggio di curvatura $r$ si ottiene
	$e/m=$ \SI{0\pm 1000000}{\coulomb\per\kg}
	che risulta compatibile con il valore atteso di
	${e/m}_{noto}=$\SI{0\pm 1000000}{\coulomb\per\kg}
