\section{Procedura operativa e svolgimento}
	Si è acceso il tetrodo regolando la tensione $U_F$ = \SI{8.0 \pm 0.1}{\volt}
	in modo da innescare la produzione di $e^{-}$ al catodo per effetto 
	termoionico.
	Si è regolato un campo accelerante $U_A=$ \SI{70 \pm 0.1}{\volt}
	dopodiché si è posta una tensione $U_G$ crescente sino a che gli 
	...
	si è osservato che aumentando la tensione $U_A$ si ottiene
	...
	la tensione $U_A$ sia in modalità rampa;tra 0 e il suo massimo 
	(\SI{80.0 \pm 0.5}{\volt}).
	Attraverso la modalità X-Y dell'oscilloscopio si è 
...
\end{figure}
	...
	Come è possibile osservare dalle \fig{f:ue1} e \fig{f:ue3}
	per valori del campo decelerante $U_E-U_A$ 
	bassi la quasi totalità degli $e^{-}$, anche qualora facciano
	...
	Si è regolato il valore di $U_A$ in maniera da osservare il massimo
	...
	A seguito si è disinserita la modalità X-Y dell'oscilloscopio 
	...
	Con tali dati si è eseguito n fit lineare 
	-RIPORTARE FIT-
	...
	Si è associato tale gap energetico alla differenza di energia 
