...
\subsection{Descrizione dell'apparato sperimentale}
	...
	\begin{itemize}
		...
		\item $U_G$ differenza di potenziale fra la griglia di
			controllo
			e la griglia catodo in modo da aumentare l'emissività
	...
	collettore
	è stato collegato a un amplificatore a
	transimpedenza.
	...
	\begin{figure} [!h]
		\centering
		\includegraphics[width=0.9\textwidth]{apparato.png}
		\caption{Schema dell'apparato impiegato.}
		\label{fig:apparato}
	\end{figure}

	Si riporta in \fig{apparato} uno schema
