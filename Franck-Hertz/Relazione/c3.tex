...
\title{Esercitazione N.3: Franck-Hertz.}
\date{24 febbraio 2017}

\begin{document}
	\maketitle
	\begin{abstract}
		In quest'esperienza si è analizzato il comportamento quantistico dei
		livelli energetici dell'atomo di Neon e si é stimato il gap di energia
		tra il livello fondamentale ed il primo di eccitazione.

		Per effettuare tale studio si sono osservati gli effetti
