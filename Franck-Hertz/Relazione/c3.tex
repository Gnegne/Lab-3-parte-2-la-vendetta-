...
\begin{document}
	...
	\begin{abstract}
		...
		tra il livello fondamentale ed i primi eccitati. Ai fini di tale studio si sono osservati gli effetti
		dissipativi degli urti anelastici tra elettroni e atomi di neon.
	\end{abstract}
