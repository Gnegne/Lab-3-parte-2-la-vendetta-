...
\maketitle
\begin{abstract}
	In quest'esperienza si sono misurate alcune delle caratteristiche delle porte NOT di un circuito integrato SN74LS04 $controllare-potrebbe-essere-SN54LS04$.
	
	Verificando il sostanziale accordo tra le grandezze misurate e quelle fornite dal costruttore.
	
	In quest'esperienza è stato montato un circuito impulsatore (\figurename{ \ref{f:impulsatore}} ) basato su  un arduino nano SN74LS244.
