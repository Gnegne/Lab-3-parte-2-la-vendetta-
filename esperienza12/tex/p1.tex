...
\paragraph{verifica funzionamento divisore e misura dei tempi di ritardo.}
	...
	\end{figure}
 	...
 	Per la misura dei tempi di ritardo, si è proceduto alla misura del ritardo, del fronte di salita e discesa, attraverso i cursori dell'oscilloscopio ottenendo i valori in \tablename{ \ref{t:div}}.
