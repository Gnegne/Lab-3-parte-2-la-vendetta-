...
\section{Flip-Flop D-Latch}
	...
	\begin{table}[htb]
		...
		\begin{tabular}{ssss}
			...
			\midrule
			0 & 0 & Q_{precedente} & {\overline{Q}}_{prec}\\
			1 & 0 & Q_{precedente} & {\overline{Q}}_{prec}\\
			0 & 1 & 0 & 1\\
			1 & 1 & 1 & 0\\
			\bottomrule
		\end{tabular}
	...
	\begin{figure}[htb]
		\centering
		\subfloat[acquisizione delle tensioni in ingresso nel ciruito D-Latch; $D$ (ch1) ed $En$ (ch2)]{
			\includegraphics[scale=0.4]{../Figs-Tabs/1_input_sfasati.png}
			\label{f:ing}
		}
		\qquad
		\subfloat[acquisizione uscita $Q$ (ch1) e tensione in ingresso $En$ (ch2)]{
			\includegraphics[scale=0.4]{../Figs-Tabs/1_data_prima.png}
			\label{f:sci}
		}
		\qquad
		\subfloat[acquisizione uscita $\overline{Q}$ (ch2) e tensione in uscita  $Q$ (ch1)]{
			\includegraphics[scale=0.4]{../Figs-Tabs/1_q_qbarra.png}
			\label{f:sci2}
		}
